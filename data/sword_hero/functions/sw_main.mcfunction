...
#INITIATE
execute as @a[tag=sword] run give @s[tag=!starto] minecraft:carrot_on_a_stick{display:{Name:'{"text":"Legendary Sword","color":"gold","bold":true}',Lore:['{"text":"-Abilities Unlocked-","italic":true}','{"text":"Equip Bonus: attack 3 agility 3"}']},HideFlags:1,Unbreakable:1b,CustomModelData:3690011,AttributeModifiers:[{AttributeName:"generic.attack_damage",Name:"generic.attack_damage",Amount:3,Operation:0,UUID:[I;-187608077,1838040435,-1418259760,1506327830],Slot:"mainhand"},{AttributeName:"generic.movement_speed",Name:"generic.movement_speed",Amount:0.02,Operation:0,UUID:[I;-1606460784,-656519506,-1315808417,104879726],Slot:"mainhand"}]} 1
...
execute at @a[tag=sword,scores={select=1..}] run data merge entity @e[type=item,limit=1,distance=0..6,nbt={Item:{id:"minecraft:carrot_on_a_stick",Count:1b}}] {PickupDelay:1,Item:{id:"minecraft:carrot_on_a_stick",Count:1b}}
execute as @e[type=item,nbt={Item:{id:"minecraft:carrot_on_a_stick"}}] run tellraw @a[tag=sword,scores={select=1..}] ["",{"text":"===========","bold":true,"color":"white"},{"text":"\n"},{"text":"Change Sword:","italic":true},{"text":"\n"},{"text":"===========","bold":true,"color":"white"},{"text":"\n"},{"text":"Starter Sword","bold":true,"color":"white","clickEvent":{"action":"run_command","value":"/trigger basic_sw add 1"}}]
#CHANGE SWORD
#-SMALL SWORD
execute as @a[tag=sword,scores={basic_sw=1..}] run clear @s carrot_on_a_stick
...
execute as @e[type=item,nbt={Item:{id:"minecraft:carrot_on_a_stick"}}] run tellraw @a[tag=sword,scores={select=1..},advancements={sword_hero:swords/rope=true}] {"text":"Rope Sword","bold":true,"color":"#9bcff7","clickEvent":{"action":"run_command","value":"/trigger sword-rope add 1"}}
execute as @a[tag=sword,scores={sword-rope=1..}] run clear @s carrot_on_a_stick
...
execute as @a[tag=sword,scores={sword-rope=1..,ropeprof=0..9,rope_smelt=0}] run give @s minecraft:carrot_on_a_stick{display:{Name:'{"text":"Rope Sword 0/10 C","color":"gold","bold":true}',Lore:['{"text":"-Abilities Locked-"}','{"text":"equip bonus:"}','{"text":"skill: Air Strike Bash"}','{"text":"special equip effect: rope"}']},CustomModelData:3690012,AttributeModifiers:[{AttributeName:"generic.attack_damage",Name:"generic.attack_damage",Amount:4,Operation:0,UUID:[I;-1112127720,-2042802221,-1781638823,-1434932982],Slot:"mainhand"},{AttributeName:"generic.movement_speed",Name:"generic.movement_speed",Amount:0.01,Operation:0,UUID:[I;-192861355,-501331428,-1515350886,-1769012557],Slot:"mainhand"}]} 1
...
execute as @e[type=item,nbt={Item:{id:"minecraft:carrot_on_a_stick"}}] run tellraw @a[tag=sword,scores={select=1..},advancements={sword_hero:swords/portal=true}] {"text":"Portal Sword","bold":true,"color":"#2B41FF","clickEvent":{"action":"run_command","value":"/trigger sword-portal add 1"}}
execute as @a[tag=sword,scores={sword-portal=1..}] run clear @s carrot_on_a_stick
...
execute as @e[type=item,nbt={Item:{id:"minecraft:carrot_on_a_stick"}}] run tellraw @a[tag=sword,scores={select=1..},advancements={sword_hero:swords/greed=true}] {"text":"Sword of Greed","bold":true,"color":"#BFAD14","clickEvent":{"action":"run_command","value":"/trigger sword-greed add 1"}}
...
execute as @a[tag=sword,scores={sword-greed=1..,greedprof=0..9,greed_smelt=0}] run give @s minecraft:carrot_on_a_stick{display:{Name:'{"text":"Sword of Greed III 0/50","color":"gold","bold":true}',Lore:['{"text":"-Abilities Locked-"}','{"text":"equip bonus: skill: \\"Assassinating Sword,\\" "}','{"text":"\\"Maneater,\\"\\"Guillotine\\""}','{"text":"and \\"Gold Rebellion\\""}','{"text":"special equip effect: "}','{"text":"Automatic self repair (high)"}']},HideFlags:1,Unbreakable:1b,CustomModelData:3690013,Enchantments:[{id:"minecraft:thorns",lvl:1s},{id:"minecraft:binding_curse",lvl:1s},{id:"minecraft:knockback",lvl:1s},{id:"minecraft:looting",lvl:1s}],AttributeModifiers:[{AttributeName:"generic.max_health",Name:"generic.max_health",Amount:6,Operation:0,UUID:[I;150718361,-1012842181,-1764496365,2145011958],Slot:"mainhand"},{AttributeName:"generic.attack_damage",Name:"generic.attack_damage",Amount:8,Operation:0,UUID:[I;634727900,-1076149122,-1531152071,-639730779],Slot:"mainhand"}]} 1
...
execute as @e[type=item,nbt={Item:{id:"minecraft:carrot_on_a_stick"}}] run tellraw @a[tag=sword,scores={select=1..},advancements={sword_hero:swords/star=true}] {"text":"Siderite Sword","bold":true,"color":"#5991FF","clickEvent":{"action":"run_command","value":"/trigger sword-star add 1"}}
...
execute as @a[tag=sword,scores={sword-star=1..,starprof=0..9,star_smelt=0}] run give @s carrot_on_a_stick{display:{Name:'{"text":"Siderite Sword 0/20 C","color":"gold","bold":true}',Lore:['{"text":"-Abilities Locked-"}','{"text":"equip bonus:"}','{"text":"skill: Shooting Star Sword"}']},CustomModelData:3690015,AttributeModifiers:[{AttributeName:"generic.attack_damage",Name:"generic.attack_damage",Amount:6,Operation:0,UUID:[I;-455555115,1679641992,-1761619034,668937757],Slot:"mainhand"},{AttributeName:"generic.max_health",Name:"generic.max_health",Amount:2,Operation:0,UUID:[I;-210198264,-1206238600,-1180093127,-855528502],Slot:"mainhand"},{AttributeName:"generic.movement_speed",Name:"generic.movement_speed",Amount:0.02,Operation:0,UUID:[I;-173912168,-26130579,-1582449710,-976207972],Slot:"mainhand"}]} 1
