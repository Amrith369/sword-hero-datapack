...
#LEVEL 3
execute at @a[scores={diamond_smelt=2,smelt=1..},nbt={Inventory:[{Slot:-106b,id:"minecraft:gold_ingot"}],SelectedItem:{id:"minecraft:diamond_sword",Count:1b,tag:{CustomModelData:3690020}}}] if score number RNG_77 matches 0..256 run tellraw @p[tag=sword] {"text":"<Smelt> Successfully Smelted Item!","bold":true,"color":"#26FF43","hoverEvent":{"action":"show_text","contents":[{"text":"+1 smelt level","italic":true,"color":"dark_purple"}]}}
...
execute at @a[scores={diamond_smelt=2,smelt=1..},nbt={Inventory:[{Slot:-106b,id:"minecraft:gold_ingot"}],SelectedItem:{id:"minecraft:diamond_sword",Count:1b,tag:{CustomModelData:3690020}}}] if score number RNG_77 matches 0..256 run scoreboard players add @p diamond_smelt 1
execute at @a[scores={diamond_smelt=2,smelt=1..},nbt={Inventory:[{Slot:-106b,id:"minecraft:gold_ingot"}],SelectedItem:{id:"minecraft:diamond_sword",Count:1b,tag:{CustomModelData:3690020}}}] if score number RNG_77 matches 0..256 run scoreboard players add @p sword-diamond 1
execute at @a[scores={diamond_smelt=2,smelt=1..},nbt={Inventory:[{Slot:-106b,id:"minecraft:gold_ingot"}],SelectedItem:{id:"minecraft:diamond_sword",Count:1b,tag:{CustomModelData:3690020}}}] if score number RNG_77 matches 0..256 run function sword_hero:level_up/diamond_smelt
execute at @a[scores={diamond_smelt=2,smelt=1..},nbt={Inventory:[{Slot:-106b,id:"minecraft:gold_ingot"}],SelectedItem:{id:"minecraft:diamond_sword",Count:1b,tag:{CustomModelData:3690020}}}] if score number RNG_77 matches 257..2048 run tellraw @p[tag=sword] {"text":"<Smelt> Item Smelt Failed!","bold":true,"color":"red","hoverEvent":{"action":"show_text","contents":[{"text":"+0 enchantment level","italic":true,"color":"dark_purple"}]}}
execute at @a[scores={diamond_smelt=2,smelt=1..},nbt={Inventory:[{Slot:-106b,id:"minecraft:gold_ingot"}],SelectedItem:{id:"minecraft:diamond_sword",Count:1b,tag:{CustomModelData:3690020}}}] if score number RNG_77 matches 257..2048 run scoreboard players set @p diamond_smelt 0
#================================================================================================================
