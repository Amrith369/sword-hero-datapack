...
#Level1
#tag @a[scores={diamond_smelt=0,smelt=1..},nbt={Inventory:[{Slot:-106b,id:"minecraft:gold_ingot"}],SelectedItem:{id:"minecraft:diamond_sword",Count:1b,tag:{CustomModelData:3690020}}}] add process
execute at @a[scores={diamond_smelt=0,smelt=1..},nbt={Inventory:[{Slot:-106b,id:"minecraft:gold_ingot"}],SelectedItem:{id:"minecraft:diamond_sword",Count:1b,tag:{CustomModelData:3690020}}}] if score number RNG_77 matches 0..1024 run tellraw @p[tag=sword] {"text":"<Smelt> Successfully Smelted Item!","bold":true,"color":"#26FF43","hoverEvent":{"action":"show_text","contents":[{"text":"+1 smelt level","italic":true,"color":"dark_purple"}]}}
#execute at @a[scores={diamond_smelt=1..,smelt=1..},nbt={Inventory:[{Slot:-106b,id:"minecraft:gold_ingot"}],SelectedItem:{id:"minecraft:diamond_sword",Count:1b,tag:{CustomModelData:3690020}}}] run tellraw @p[tag=sword] {"text":"<Smelt> FAILED! Quartz Needed To Smelt Further","bold":true,"color":"#D5FFD4","hoverEvent":{"action":"show_text","contents":[{"text":"Different materials required each rank","italic":true,"color":"dark_purple"}]}}
execute at @a[scores={diamond_smelt=0,smelt=1..},nbt={Inventory:[{Slot:-106b,id:"minecraft:gold_ingot"}],SelectedItem:{id:"minecraft:diamond_sword",Count:1b,tag:{CustomModelData:3690020}}}] if score number RNG_77 matches 0..1024 run scoreboard players add @p diamond_smelt 1
execute at @a[scores={diamond_smelt=0,smelt=1..},nbt={Inventory:[{Slot:-106b,id:"minecraft:gold_ingot"}],SelectedItem:{id:"minecraft:diamond_sword",Count:1b,tag:{CustomModelData:3690020}}}] if score number RNG_77 matches 0..1024 run scoreboard players add @p sword-diamond 1
execute at @a[scores={diamond_smelt=0,smelt=1..},nbt={Inventory:[{Slot:-106b,id:"minecraft:gold_ingot"}],SelectedItem:{id:"minecraft:diamond_sword",Count:1b,tag:{CustomModelData:3690020}}}] if score number RNG_77 matches 1025..2048 run tellraw @p[tag=sword] {"text":"<Smelt> Item Smelt Failed!","bold":true,"color":"red","hoverEvent":{"action":"show_text","contents":[{"text":"+0 enchantment level","italic":true,"color":"dark_purple"}]}}
execute at @a[scores={diamond_smelt=0,smelt=1..},nbt={Inventory:[{Slot:-106b,id:"minecraft:gold_ingot"}],SelectedItem:{id:"minecraft:diamond_sword",Count:1b,tag:{CustomModelData:3690020}}}] if score number RNG_77 matches 1025..2048 run scoreboard players set @p diamond_smelt 0
#================================================================================================================
