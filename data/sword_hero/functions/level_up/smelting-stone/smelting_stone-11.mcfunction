...
execute at @a[scores={stone_smelt=10,smelt=1..},nbt={Inventory:[{Slot:-106b,id:"minecraft:quartz"}],SelectedItem:{id:"minecraft:stone_sword",Count:1b,tag:{CustomModelData:3690017}}}] if score number RNG_77 matches 0..1 run scoreboard players add @p stone 1
