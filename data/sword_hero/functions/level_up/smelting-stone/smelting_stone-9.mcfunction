...
execute at @a[scores={stone_smelt=8,smelt=1..},nbt={Inventory:[{Slot:-106b,id:"minecraft:quartz"}],SelectedItem:{id:"minecraft:stone_sword",Count:1b,tag:{CustomModelData:3690017}}}] if score number RNG_77 matches 0..4 run scoreboard players add @p stone_smelt 1
execute at @a[scores={stone_smelt=8,smelt=1..},nbt={Inventory:[{Slot:-106b,id:"minecraft:quartz"}],SelectedItem:{id:"minecraft:stone_sword",Count:1b,tag:{CustomModelData:3690017}}}] if score number RNG_77 matches 0..4 run scoreboard players add @p sword-stone 1
execute at @a[scores={stone_smelt=8,smelt=1..},nbt={Inventory:[{Slot:-106b,id:"minecraft:quartz"}],SelectedItem:{id:"minecraft:stone_sword",Count:1b,tag:{CustomModelData:3690017}}}] if score number RNG_77 matches 0..4 run function sword_hero:level_up/stone_smelt
execute at @a[scores={stone_smelt=8,smelt=1..},nbt={Inventory:[{Slot:-106b,id:"minecraft:quartz"}],SelectedItem:{id:"minecraft:stone_sword",Count:1b,tag:{CustomModelData:3690017}}}] if score number RNG_77 matches 5..2048 run tellraw @p[tag=sword] {"text":"<Smelt> Item Smelt Failed!","bold":true,"color":"red","hoverEvent":{"action":"show_text","contents":[{"text":"+0 enchantment level","italic":true,"color":"dark_purple"}]}}
execute at @a[scores={stone_smelt=8,smelt=1..},nbt={Inventory:[{Slot:-106b,id:"minecraft:quartz"}],SelectedItem:{id:"minecraft:stone_sword",Count:1b,tag:{CustomModelData:3690017}}}] if score number RNG_77 matches 5..2048 run scoreboard players set @p stone_smelt 0
#================================================================================================================
